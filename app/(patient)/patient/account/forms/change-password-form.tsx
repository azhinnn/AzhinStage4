...
import { updatePatientPassword } from "@/helper/patientActions";
...
export default function ChangePatientPasswordForm({ data }: any) {
  ...
  async function onSubmit(data: z.infer<typeof FormSchema>) {
    ...
    const res = await updatePatientPassword(data);
    if (res.status === 200) {
