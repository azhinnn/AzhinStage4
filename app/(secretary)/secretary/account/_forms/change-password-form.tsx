...
import { updateSecretaryPassword } from "@/helper/secretaryActions";
...
export default function ChangeSecretaryPasswordForm({ data }: any) {
  ...
  async function onSubmit(data: z.infer<typeof FormSchema>) {
    ...
    const res = await updateSecretaryPassword(data);
