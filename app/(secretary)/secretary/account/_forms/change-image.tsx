...
import { updateSecretaryImage } from "@/helper/secretaryActions";
import { getUserCookie, setUserCookie } from "@/helper/authActions";

export default function ChangeSecretaryImage(data: any) {
